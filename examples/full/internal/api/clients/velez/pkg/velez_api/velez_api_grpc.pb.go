...
func (c *velezAPIClient) UpgradeSmerd(ctx context.Context, in *UpgradeSmerd_Request, opts ...grpc.CallOption) (*UpgradeSmerd_Response, error) {
	...
	err := c.cc.Invoke(ctx, VelezAPI_UpgradeSmerd_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *velezAPIClient) AssembleConfig(ctx context.Context, in *AssembleConfig_Request, opts ...grpc.CallOption) (*AssembleConfig_Response, error) {
	...
	err := c.cc.Invoke(ctx, VelezAPI_AssembleConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *velezAPIClient) MakeConnections(ctx context.Context, in *MakeConnections_Request, opts ...grpc.CallOption) (*MakeConnections_Response, error) {
	...
	err := c.cc.Invoke(ctx, VelezAPI_MakeConnections_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *velezAPIClient) BreakConnections(ctx context.Context, in *BreakConnections_Request, opts ...grpc.CallOption) (*BreakConnections_Response, error) {
	...
	err := c.cc.Invoke(ctx, VelezAPI_BreakConnections_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *velezAPIClient) SearchImages(ctx context.Context, in *SearchImages_Request, opts ...grpc.CallOption) (*SearchImages_Response, error) {
	...
	err := c.cc.Invoke(ctx, VelezAPI_SearchImages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
